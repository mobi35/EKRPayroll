namespace EyeKnowRight.Migrations
{
    ...
    public partial class meme : DbMigration
    {
                ...
                c => new
                    {
                        ...
                        Remarks = c.String(),
                        leaveEarned = c.Boolean(nullable: false),
                    })
                ...
                c => new
                    {
                        ...
                        MyProperty = c.Int(),
                        MaternityLeave = c.Single(nullable: false),
                        PaternityLeave = c.Single(nullable: false),
                        SickLeave = c.Single(nullable: false),
                        BereavementLeave = c.Single(nullable: false),
                        MedicalLeave = c.Single(nullable: false),
                        PersonalLeave = c.Single(nullable: false),
                        ...
                        SickLeaveCredit = c.Int(nullable: false),
                        SupervisedDepartment = c.String(),
                    })
                ...
                c => new
                    {
                        ...
                        SalaryInrease = c.Single(nullable: false),
                    })
